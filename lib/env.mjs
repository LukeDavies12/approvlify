...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_STRIPE_FLOW_PRICE_ID: z.string().min(1),        
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_PUBLIC_STRIPE_FLOW_PRICE_ID: process.env.NEXT_PUBLIC_STRIPE_FLOW_PRICE_ID,        NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY,
